...
use crate::{modules::llm_client::errors::TranslatorResult, server::config::ServerConfig};
...
pub struct TranslateTask{
    ...
    #[serde(deserialize_with = "trim_string")]
    #[schema(default = r"This is my rifle. There are many like it, but this one is mine.
